...
const Release = () => {
  return (
    <div className="page-content">
      <h1>
        release.sh
        <a href="https://github.com/m-chmielewski/scripts/blob/main/mern/release.sh">
          <img alt="" src={gh}></img>
        </a>
      </h1>
      ...
      <h2>Summary</h2>
      <p>
        The script streamlines all the steps necessary to release MERN app to
        remote server.
        <br />
        <br /> Both, frontend and backend are available under the same domain.
        React app is served by Express.
      </p>
      <h2>Installation</h2>
      <code>
        cd ~<br />
